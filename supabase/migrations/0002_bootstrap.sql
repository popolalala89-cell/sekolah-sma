-- =====================================================================
-- SEKOLAH-SMA — 0002_bootstrap.sql  (jalankan SETELAH 0001 sukses)
-- Isi data awal: sekolah, tahun ajaran aktif, jurusan, mapel, akun admin
--
-- SYARAT (kerjakan dulu di Dashboard):
--   Authentication → Users → Add user
--   email: admin@sekolah.local   password: (bikin kuat, disimpan baik-baik)
--   (Centang "Auto Confirm User" jika tersedia)
-- =====================================================================
...
-- 7) Isi baris akun admin (peran admin sudah di raw_app_meta_data baris 1)
...
-- 8) PIN admin SEMENTARA (opsional, bisa di-set lewat UI nanti)
-- update public.akun set pin_hash = crypt('123456', gen_salt('bf'))
--   where peran = 'admin' and pin_hash is null;

-- =====================================================================
-- VERIFIKASI — jalankan query baris ini terpisah, harusnya semua >= 1:
