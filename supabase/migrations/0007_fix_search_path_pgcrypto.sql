...
begin
  ...
  --    CATATAN: kolom auth.users.email GENERATED di versi Supabase ini
  --    -> JANGAN di-insert; terisi otomatis dari identities.
  ...
  -- 2) identity (wajib supaya bisa login email+password; email users
  --    dan identities.email keduanya GENERATED -> jangan diisi manual)
